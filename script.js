...
(function(){
    // Soporte para múltiples reproductores (el mini/footer y el clásico)
    ...
    document.addEventListener('DOMContentLoaded', setupMiniPlayer);
})();

// ==== REPRODUCTOR GRANDE (opcional - IDs clásicos) ====
(function(){
    ...
    if(audio && playPauseBtn && volumeControl){
        audio.src = config.streamURL;
        audio.crossOrigin = "anonymous";
        audio.volume = volumeControl.valueAsNumber || 1;
